...
| 2.11 | Grades Module                                  | 🟡 In Progress | 2026-02-22 | `apps/api/src/modules/grades/grades.controller.ts`, `apps/api/src/modules/grades/grades.service.ts`, `apps/api/src/modules/grades/grades.repository.ts`, `apps/api/src/modules/grades/grades.types.ts`, `apps/api/src/modules/grades/grades.module.ts`, `apps/api/src/modules/grades/dto/create-grade.dto.ts`, `apps/api/src/modules/grades/dto/grade-query.dto.ts`, `packages/shared/src/validators/grade.schema.ts`, `packages/shared/src/validators/index.ts`, `apps/api/src/app.module.ts` |

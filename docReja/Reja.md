...
| FAZA 2  | 🟡 In Progress | 2026-02-21 | `apps/api/src/app.module.ts`, `apps/api/src/modules/auth/*`, `apps/api/src/modules/users/*`, `apps/api/src/modules/tenants/*`, `apps/api/src/modules/teachers/*`, `apps/api/src/modules/students/*`, `apps/api/src/modules/parents/*`, `apps/api/src/modules/classes/*` |
| FAZA 3  | ⚪ Not Started | -          | -                                                                                                                                                                                                                                                                       |
| FAZA 4  | ⚪ Not Started | -          | -                                                                                                                                                                                                                                                                       |
| FAZA 5  | ⚪ Not Started | -          | -                                                                                                                                                                                                                                                                       |
| FAZA 6  | ⚪ Not Started | -          | -                                                                                                                                                                                                                                                                       |
...
| 2.1  | NestJS Project Setup                           | 🟡 In Progress | 2026-02-21 | `apps/api/src/app.module.ts`, `apps/api/src/modules/auth/*`, `apps/api/src/modules/users/*`, `apps/api/src/modules/tenants/*`, `apps/api/src/modules/teachers/*`, `apps/api/src/modules/students/*`, `apps/api/src/modules/parents/*`, `apps/api/src/modules/classes/*`                                                                                                                                                                                                                                                                                                              |
